<?xml version="1.0" encoding="UTF-8" standalone="no"?><cfLuceeConfiguration hspw="" salt="12FB74C3-69CD-4348-A839A29127ED8B7C" version="4.5"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<custom-tag custom-tag-deep-search="true" custom-tag-local-search="true" extensions="cfc,lucee,cfm,lucee,cfs" use-cache-path="false">
		<mapping physical="{lucee-web}/customtags/" trusted="yes"/>
        <mapping physical="/var/www/jobs/tags/" trusted="yes"/>
	...
	<application cache-directory="{lucee-web}/cache/" cache-directory-max-size="100mb" cached-after="0,0,0,0" type-checking="true"/>
...
<rest/><gateways/><orm/><compiler/><charset/><java inspect-template="always"/><regional/><error/><security/><update/><queue/></cfLuceeConfiguration>